    ...
    <div class="container basket__container">
      ...
      <table class="basket__table">
        ...
        <tbody class="basket__tbody">
          <tr class="basket__tr">
            <td class="basket__card-product">
              <figure class="basket__card-figure">
                <img
                  src="@/assets/img/royal-classic.jpg"
                  alt="Basket with flowers"
                  class="basket__card-image"
                />
              </figure>
            </td>
            <td class="basket__card-details">
              <div class="basket__card-info">
                <h3 class="basket__card-title">Royal Classic</h3>
                <p class="basket__card-price">$150</p>
                <p class="basket__card-size">SIZE: 1 DOZEN</p>
              </div>
              <div class="basket__dozen">
                <button class="basket__dozen-button" @click="decrement">
                  -
                </button>
                <span class="basket__dozen-value">{{ count }}</span>
                <button class="basket__dozen-button" @click="increment">
                  +
                </button>
              </div>
            </td>
            <td class="basket__price-detail">
      ...
      <button class="basket__button">CHECK OUT</button>
    </div>
  </section>
</template>
